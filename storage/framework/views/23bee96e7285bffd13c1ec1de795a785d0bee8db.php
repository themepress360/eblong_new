                            ...
                            <div class="wt-proposalhead">
                                ...
                                <ul class="wt-userlisting-breadcrumb wt-userlisting-breadcrumbvtwo">
                                    ...
                                    <?php if(!empty($job->location->title)): ?>
                                        <li><span><img src="<?php echo e(asset(Helper::getLocationFlag($job->location->flag))); ?>" alt="<?php echo e(trans('lang.img')); ?>" style="width:18px;height:11px;"> <?php echo e($job->location->title); ?></span></li>
                                    <?php endif; ?>
                                ...
                                <div class="wt-proposalamount accordion">
                                    ...
                                    <ul class="wt-totalamount collapse show" id="collapseOne" aria-labelledby="headingOne">
                                        ...
                                        <li v-cloak>
                                            ...
                                            <span>
                                                <strong>“ <?php echo e(trans('lang.receiving_amount')); ?> ”</strong>
