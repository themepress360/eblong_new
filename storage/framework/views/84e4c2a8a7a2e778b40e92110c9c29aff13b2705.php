                            ...
                            <div class="wt-personalskillshold tab-pane active fade show" id="wt-skills">
                                <?php echo Form::open(['url' => '', 'class' =>'wt-userform', 'id' => 'freelancer_profile', '@submit.prevent'=>'submitFreelancerProfile']); ?>
                                    ...
                                    <div class="wt-videos-holder wt-tabsinfo la-footer-setting">
                                        <?php if(file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/personal-detail/videos.blade.php'))): ?> 
                                            <?php echo $__env->make('extend.back-end.freelancer.profile-settings.personal-detail.videos', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>   
                                        <?php else: ?> 
