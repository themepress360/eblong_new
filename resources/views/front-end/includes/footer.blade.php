                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="wt-footerlogohold">
                                @if (!empty($footer['footer_logo']))
                                    <strong class="wt-logo"><a href="{{{ url('/') }}}"><img src="http://ebelong.com/passively/public/uploads/settings/general/1585698705-ebelong.png" alt="company logo here"></a></strong>
                                @endif
